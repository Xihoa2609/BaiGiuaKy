...
class _DetailPageState extends State<DetailPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color.fromARGB(255, 240, 141, 225),
      body: ListView(
        children: [
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SingleChildScrollView( // Bọc Row bên trong SingleChildScrollView
            ...
            child: Row(
              children: [
                Align(
                  child: Container(
                    height: 120,
                    width: 100, // Điều chỉnh width của Container
